...
As the name suggests, gossip algorithms are asynchronous protocols that build upon how rumors spread in a population.

Consider a network of $n$ nodes denoted by $V={1,...,n}$. Let $E \subset V \times V$ denote the bidirectional links along which node pairs can communicate and let this network graph be denoted by $G = (V,E)$ where $G$ constantly changes in terms of $V$ and $E$.
