...
Its infrastructure consists of countless networks which are interconnected by routers.
This introduces a connection establishment problem when a peer-to-peer network is build up from a set of end user devices\footnote{In this context we define an end user device as a personal computer or a consumer device (e.g. a PDA or a smart phone)}.
