...
Existing implementations of CYCLON and SCAMP could be used and adapted for the handshaking-based simulation.

The first part of the experiments revolve around handshaking with CYCLON and SCAMP while the second part of the  experiments compares the new algorithm SCAMPLON with CYCLON.
...
The experiments with CYCLON are done with $c = 20$ and $l = 5$ while the experiments with SCAMP are done with $c=2$.
...
The local clustering coefficient defines how close a node and its immediate neighbors are to be a clique.
...
Figure \ref{fig:cluster_cyclon}, Figure \ref{fig:cluster_cyclon2} and Figure \ref{fig:cluster_cyclon3} show the average clustering coefficient with CYCLON, run over $500$ cycles. The x-axis shows the average cluster coefficient while the y-axis shows the number of cycles.
...
Figure \ref{fig:cluster_scamp1}, Figure \ref{fig:cluster_scamp2} and Figure \ref{fig:cluster_scamp3} show the average clustering coefficient with SCAMP, run over $500.00$ cycles.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=7.3cm]{Images/statistics/cyclon_1000_c20/avgpath/f0}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=7.3cm]{Images/statistics/cyclon_1000_c20/avgpath/f10}
    \caption{average path length of the CYCLON protocol (10\% failure)}
    \label{fig:path_cyclon2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=7.3cm]{Images/statistics/cyclon_1000_c20/avgpath/f40}
    \caption{average path length of the CYCLON protocol (40\% failure)}
    \label{fig:path_cyclon3}
\end{figure}
