...
Almost all current solutions utilize a Client-Server-Infrastructure with the Server being the final decision instance in case of a conflict.

\section{Statement of the problem}

The centralization introduces certain limitations and concerns: The Server is a Single Point of Failur and introduces privacy and economic intelligence issues.
