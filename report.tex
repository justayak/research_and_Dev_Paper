...
The centralization presents certain problems: The Server is a Single Point of Failure and introduces privacy and economic intelligence issues as well as limitations in terms of service and scalability. A possible solution to this problems is the full decentralization of the system.
An eventual constistent (optimistic) replication (CRDT) with a well-scaling allocation algorithms like LSEQ can be used to synchronize local copies.
The focus of this paper will be on the underlining network topology. 
