...
\title{Gossip Protocols in Wide Area Networks}
...
The service periodically communicates with its peers to generate new samples and to adapt to churn - this creates a small network overhead and includes connection to other peers frequently.
This will be expansive in a wide area network.
