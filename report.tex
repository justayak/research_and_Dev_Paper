...
A possible application for gossip-based peer-to-peer networks over the internet could be a serverless massive collaborative editor \cite{nedelec:hal-00921633}\cite{MassCollab} in a web browser.
...
A peer-to-peer connection can be established using WebRTC. 
