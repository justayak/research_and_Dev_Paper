...
For establishing a peer-to-peer connection under WebRTC, however, certain efforts must be taken.
To set up a connection between peers, they need to perform a handshake, consisting of an offer by one client and an responding answer by the other.
